        ...
        <div className={styles.legalPage}>
            ...
            <section className={styles.section}>
                <div className={styles.containerSm}>
                    ...
                    <h3>Personal Data</h3>
                    <p>Demographic and other personally identifiable information (such as your name, email address, and contact details) that you voluntarily give to us when you choose to participate in various activities related to the Site, such as chat, posting messages in comment sections or forums, liking posts, sending feedback, and responding to surveys.</p>
